...
def userGuess(usedAlpha, answer, guess):
    ...
    if letter in answer:
        # This is utilizing enumerate to replace the getIndexPositions 
        # to find the indicies to replace
...
# This was the old function replaced with enumerate
